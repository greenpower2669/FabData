...
def replace_section_or_done(text, start, end, new_body, done_marker, label):
...
if 'versionName = "0.23.0"' not in build:
    build = replace_once_or_done(
        build,
        'versionCode = 56\n        versionName = "0.22.0"',
        'versionCode = 57\n        versionName = "0.23.0"',
        "version"
...
""",
    "hide adaptive from band selector"
)
...
print("v0.23.0 UI/TODO patch applied")
